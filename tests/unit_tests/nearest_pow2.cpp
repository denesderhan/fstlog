...
TEST_CASE("nearest_pow2") {
    SECTION("size_t") {
        auto extent = GENERATE(table<size_t, size_t>({
            ...
            std::tuple<std::size_t, std::size_t>{std::size_t(5), std::size_t(4)},
            std::tuple<std::size_t, std::size_t>{std::size_t(6), std::size_t(8)},
            std::tuple<std::size_t, std::size_t>{std::size_t(7), std::size_t(8)},
            std::tuple<std::size_t, std::size_t>{std::size_t(8), std::size_t(8)},
            std::tuple<std::size_t, std::size_t>{std::size_t(10), std::size_t(8)},
            std::tuple<std::size_t, std::size_t>{std::size_t(15), std::size_t(16)},
            std::tuple<std::size_t, std::size_t>{std::size_t(16000), std::size_t(16384)},
    ...
    SECTION("uint32") {
        auto extent = GENERATE(table<std::uint32_t, std::uint32_t>({
            ...
            std::tuple<std::uint32_t, std::uint32_t>{std::uint32_t(5), std::uint32_t(4)},
            std::tuple<std::uint32_t, std::uint32_t>{std::uint32_t(6), std::uint32_t(8)},
            std::tuple<std::uint32_t, std::uint32_t>{std::uint32_t(7), std::uint32_t(8)},
            std::tuple<std::uint32_t, std::uint32_t>{std::uint32_t(8), std::uint32_t(8)},
            std::tuple<std::uint32_t, std::uint32_t>{std::uint32_t(10), std::uint32_t(8)},
            std::tuple<std::uint32_t, std::uint32_t>{std::uint32_t(15), std::uint32_t(16)},
            std::tuple<std::uint32_t, std::uint32_t>{std::uint32_t(16000), std::uint32_t(16384)},
    ...
    SECTION("uint16") {
        auto extent = GENERATE(table<std::uint16_t, std::uint16_t>({
            ...
            std::tuple<std::uint16_t, std::uint16_t>{std::uint16_t(5), std::uint16_t(4)},
            std::tuple<std::uint16_t, std::uint16_t>{std::uint16_t(6), std::uint16_t(8)},
            std::tuple<std::uint16_t, std::uint16_t>{std::uint16_t(7), std::uint16_t(8)},
            std::tuple<std::uint16_t, std::uint16_t>{std::uint16_t(8), std::uint16_t(8)},
            std::tuple<std::uint16_t, std::uint16_t>{std::uint16_t(10), std::uint16_t(8)},
            std::tuple<std::uint16_t, std::uint16_t>{std::uint16_t(15), std::uint16_t(16)},
            std::tuple<std::uint16_t, std::uint16_t>{std::uint16_t(16000), std::uint16_t(16384)},
